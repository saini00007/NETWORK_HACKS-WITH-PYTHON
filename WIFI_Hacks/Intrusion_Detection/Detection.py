...
# Number of max probe responses with different SSIDs from one address
max_ssids_per_addr = 5
probe_resp = {}

# Number of max deauths in timespan seconds
nr_of_max_deauth = 10
deauth_timespan = 23
deauths = {}
